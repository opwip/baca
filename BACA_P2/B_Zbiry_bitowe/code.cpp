...
int main() {
    ...
    int sete = 15;
    int* seta = &set;
    cout << Cardinality(33) << endl;  // 
    cout << LessThan(5, 7) << endl;     // 
    cout << LessThan(9, 5) << endl;     // 
    cout << LessThan(5, 9) << endl;     // 
    cout << LessThan(0, 1) << endl;     // 
    cout << GreatThan(7, 5) << endl;    // 
    cout << GreatThan(9, 5) << endl;    // 
    cout << GreatThan(5, 9) << endl;    // 
    cout << GreatThan(1, 0) << endl;    // 
    cout << GreatEqual(7, 5) << endl;   // 
    cout << GreatEqual(5, 5) << endl;   // 
    cout << GreatEqual(5, 9) << endl;   // 
    cout << GreatEqual(0, 0) << endl;   // 
    return 0;
}
